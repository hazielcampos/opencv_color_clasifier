...
cv2.createTrackbar("LS", "Trackbars Red", 87, 255, nothing)
cv2.createTrackbar("LV", "Trackbars Red", 111, 255, nothing)
...
cv2.createTrackbar("LV", "Trackbars Green", 45, 255, nothing)
